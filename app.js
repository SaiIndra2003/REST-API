...
app.use((req, res, next) => {
  //We would set the header of response (Server) here so that cors error is handled
  ...
  ); // Allows the access to the specified types of headers
  if (req.method === "OPTIONS") {
    // Options req is send by browser whenever put/patch/delete/post method is done
